...
/*  SPI0 */
#define SPI_PSELSCK0              2 //31   /*!< GPIO pin number for SPI clock (note that setting this to 31 will only work for loopback purposes as it not connected to a pin) */
#define SPI_PSELMOSI0             1 //20   /*!< GPIO pin number for Master Out Slave In    */
#define SPI_PSELMISO0             0 //22   /*!< GPIO pin number for Master In Slave Out    */
#define SPI_PSELSS0               29 //30   /*!< GPIO pin number for Slave Select           */

/*  SPI1 */
#define SPI_PSELSCK1              2  //29   /*!< GPIO pin number for SPI clock              */
#define SPI_PSELMOSI1             1  //21   /*!< GPIO pin number for Master Out Slave In    */
#define SPI_PSELMISO1             0  //23   /*!< GPIO pin number for Master In Slave Out    */
#define SPI_PSELSS1               28   /*!< GPIO pin number for Slave Select           */

//#define DEBUG
#ifdef DEBUG
#define DEBUG_EVENT_READY_PIN0    20 //10    /*!< when DEBUG is enabled, this GPIO pin is toggled everytime READY_EVENT is set for SPI0, no toggling means something has gone wrong */
